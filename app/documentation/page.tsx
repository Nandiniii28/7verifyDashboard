...
export default function DocumentationPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      {/* Main Content */}
      <div className={`flex-1 flex flex-col ${isMobile ? "ml-0" : sidebarOpen ? "ml-60" : "ml-28"}`}>
        {/* Header */}
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Welcome to our API documentation. This guide will help you get started with integrating our
                ...
                {activeSection === "authentication" && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Our API uses API keys for authentication. Include your API key in the Authorization header of
                        your requests.
                      </p>
                    </div>
                      ...
                      {apiEndpoints.map((endpoint, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg p-4">
                          <div className="flex items-center mb-2">
                            <span
                              className={`inline-flex px-2 py-1 text-xs font-medium rounded mr-3 ${getMethodColor(endpoint.method)}`}
                            >
                              {endpoint.method}
                            </span>
                ...
                {activeSection === "examples" && (
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Here are some code examples to help you get started with our API.
                      </p>
                    </div>
