...
export default function Header({ isOpen, onToggle }) {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md shadow-professional border-b border-gray-100 sticky top-4 z-20" style={{ borderRadius:"20px", margin:"10px 20px"}}>
                  ...
                  <div className="p-4 hover:bg-gray-50 border-b border-gray-50 transition-colors">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900">New API request received</p>
                  ...
                  <div className="p-4 hover:bg-gray-50 border-b border-gray-50 transition-colors">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mt-1">All services are running smoothly</p>
                  ...
                  <div className="p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mt-1">Welcome email sent automatically</p>
